...
<body>
    ...
    <form method="post" action="IzbiraTrenerja.php">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <select name="program">
                        <option value="0">Yoga 20€ na mesec</option>
                        <option value="1">Calisthenics 25€ na mesec</option>
                        <option value="2">Dvigovanje uteži 25€ na mesec</option>
                        <option value="3">Kondicijski trening 30€ na mesec</option>
                    </select>
                </td>
            </tr>
            <tr>
    ...
    <div class="row">
        <div class="column">
            <img src="Trener1.jpg" alt="Tom Lut - Specializiran za jogo in prehrano">
        </div>
        <div class="column">
            <img src="Trener2.png" alt="Nejc Detar - Specializiran za dvigovanje uteži in skupinske treninge">
        </div>
        <div class="column">
            <img src="Trener3.jpg" alt="Matija Novak - Specializiran za kalisteniko in planiranje vadb">
        </div>
    </div>
